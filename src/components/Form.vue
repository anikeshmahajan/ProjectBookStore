<template>
  ...
  <div class="page-content">
		<div class="form-v7-content">
			<div class="form-left">
				<img src="../assets/2766594.png" alt="form">
				
				<p class="text-2">Online Book Shopping</p>
			</div>
			<form class="form-detail" action="#" method="post" id="myform">
				...
				<div class="form-row">
					<label for="your_email">Email Id</label>
				...
				<div class="form-row">
					...
					<input type="number" name="" id="comfirm_password" class="input-text" required>
				</div>
...
export default {
  ...
  methods: {
    submit() {
      alert("name is " + this.name + " email is " + this.email);
    },
  },
};
</script>
